...
if ($_POST['action']=='create') {
    if (isset ($_POST['ytid'])) {
        ...
        if ($_SESSION["status"] == 0) {
            ...
            header("Location:/~rschreib/views/video.php?v=" . $_POST['ytid']);
        } else {
            header("Location:/~rschreib/views/video.php?v=" . $_POST['ytid']);
        }
    } else {
        ...
        if ($_SESSION["status"] == 0) {
            ...
            header("Location:/~rschreib/views/blog.php?p=" . $_POST['pid']);
        } else {
            header("Location:/~rschreib/views/blog.php?p=" . $_POST['pid']);
        }
    }
...
elseif ($_GET['action'] == 'delete') {
    ...
    elseif (isset($_GET['pid'])) {
        header("Location:/~rschreib/views/blog.php?p=" . $_GET['pid']);
    }
}
else {
